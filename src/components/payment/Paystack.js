...
// const Paystack = ({ onPaymentSuccess, onClose, amount, userEmail }) => {
//   const handlePaystackPayment = async () => {
//     // Implement your Paystack payment logic here
//     // You can make API calls to initiate the payment and handle the response
//     try {
//       // Make an API call to your backend to initiate Paystack payment
//       // ...

//       // If payment is successful, call onPaymentSuccess
